      ...
      projects: [
        {
          ...
          desc: "Centralized API gateway for ERP modules",
          branch: "main",
          source: "GitHub",
          envs: 4,
          healthy: 4,
        ...
        },
        {
          ...
          type: "Microservice",
          desc: "Handles inventory management APIs",
          branch: "develop",
          source: "Azure DevOps",
          envs: 3,
          healthy: 2,
      ...
      projects: [
        {
          ...
          type: "Automation",
          desc: "Automated regression test suite",
          branch: "main",
          source: "GitHub",
          envs: 2,
          healthy: 2,
        ...
        },
        {
          ...
          desc: "Load and stress testing for ERP APIs",
          branch: "testing",
          source: "Azure DevOps",
          envs: 1,
          healthy: 1,
      ...
      projects: [
        {
          ...
          type: "Mobile App",
          desc: "Driver management application",
          branch: "release",
          source: "GitHub",
          envs: 2,
          healthy: 2,
        ...
        {
          name: "Temple Admin App",
          type: "Mobile App",
          desc: "Mobile app for temple administration",
          branch: "main",
          source: "Azure DevOps",
          envs: 3,
          healthy: 3,
